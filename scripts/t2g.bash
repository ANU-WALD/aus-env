...
ogr2ogr -f GeoJSON -lco COORDINATE_PRECISION=3 -dialect SQLite geo/ibra7_regions.json topo/ibra7_regions_topo.json
ogr2ogr -f GeoJSON -lco COORDINATE_PRECISION=3 -dialect SQLite geo/LGA11aAust.json topo/LGA11aAust_topo.json
